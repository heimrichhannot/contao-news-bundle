...
class NewsList
{
    ...
    /**
     * Filter out relocated news within list mode
     */
    private function addRelocateFilter()
    {
        $t                     = static::$table;
        $this->filterColumns[] = "$t.relocate = 'none'";
    }
    ...
    private function addCategoryFilter()
    {
        ...
        if (!empty($GLOBALS['NEWS_FILTER_EXCLUDE']) && is_array($GLOBALS['NEWS_FILTER_EXCLUDE']) && !empty($GLOBALS['NEWS_FILTER_EXCLUDE'])) {
